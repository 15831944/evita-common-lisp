...
//
// @(#)$Id: //proj/evcl3/mainline/arch/x86/x86_asm.cpp#4 $
//
// Description:
...
// X86Assembler::asm_Jb
//
void X86Assembler::asm_Jb(uint nOpcode, Label& rLabel)
{
...
//////////////////////////////////////////////////////////////////////
//
//  X86Assembler::installFunObj
//
Val
X86Assembler::installFunObj(const Defun* pDefun)
{
...
//////////////////////////////////////////////////////////////////////
//
//  X86Assembler::makeFunObj
//
Val
X86Assembler::makeFunObj(const Defun* pDefun)
{
    resolve_jumps();
    ...
    // Embed lisp object
    {
        for (uint i = 0; i < m_cAnnons; i++)
        {
            ...
            case FunObj::Annon::Type_DllLink:
            {
                ...
                pFunObj->PatchU32(
                    nAddr,
                    static_cast<uint32>(entry->ToInt()) );
                break;
            ...
            case FunObj::Annon::Type_Label:
            {
                ...
                pFunObj->PatchU32(
                    nAddr,
                    static_cast<uint32>(reinterpret_cast<Int>(
...
//      min     max
//      0       -1      nothing to emit
//      n       n       cmp reg_n, n; jne arity_error
//      n       -1      cmp reg_n, n; jlt arity_error
//      n       m       cmp reg_n, n; jlt arity_erorr; cmp ecx, m; jgt
//
void
X86Assembler::emit_prologue(Defun* pDefun)
{
...
//
void
X86Assembler::emit_epilogue(Defun* pDefun)
{
    if (pDefun->m_fCheckArity)
    {
        label(pDefun->m_oArityError);
        call(ea($tcb, SVC_arity_error));
    }
} // X86Assembler::emit_epilogue


//////////////////////////////////////////////////////////////////////
//
//  X86Assembler::resolve_jumps
//
void
X86Assembler::resolve_jumps()
{
...
//////////////////////////////////////////////////////////////////////
//
// X86Assembler::shift_labels
//
void X86Assembler::shift_labels(uint nAddr, uint nInc)
{
    m_nAddr += nInc;
