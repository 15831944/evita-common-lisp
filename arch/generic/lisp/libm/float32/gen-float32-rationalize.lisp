...
;;;;
;;;; evcl - 12 - Number - float32-rationalize
;;; arch/generic/lisp/math/gen-math-f32-rationalize.lisp
;;;
...
;;;
;;; @(#)$Id: //proj/evcl3/mainline/arch/generic/lisp/libm/float32/gen-float32-rationalize.lisp#1 $
;;;
;;; Description:
      ...
      (cond
        ...
        ((>= ix #x7f800000) ; Inf or NaN
          (error 'arithmetic-error
                 ...
                 :operands (list x) ) )
        (t ; Normal
          (values (logior (ash 1 23) (logand ix #x007fffff))
                  (- (ash ix -23) 127 23) ) ))
    (if (or (zerop f) (>= exp 0))
