...
//
// @(#)$Id: //proj/evcl3/mainline/arch/x64/mini/x64_mini_03_direct_call.cpp#3 $
//
#include "../x64_asm.h"
...
Val update_callers(Val name, Val new_callee)
{
    ...
    Val end = svref(caller_set, Fixnum::Encode(0));
