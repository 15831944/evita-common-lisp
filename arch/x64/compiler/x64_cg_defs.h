...
//
// @(#)$Id: //proj/evcl3/mainline/arch/x64/compiler/x64_cg_defs.h#2 $
//
#if !defined(INCLUDE_compiler_cg_x64_defs_h)
#define INCLUDE_compiler_cg_x64_defs_h
...
typedef X64::Function::Annon Annon;
...
#endif //!defined(INCLUDE_compiler_cg_x64_defs_h)
