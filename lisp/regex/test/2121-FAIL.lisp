...
;  0/144, skip=0
; Try "perl-584.retest"
; GC Fence 4,280,112 => 8,766,136
; GC Fence 4,338,800 => 8,795,816
; GC Fence 4,294,688 => 8,825,088
;  0/945, skip=20
; Try "onig.retest"
;   FAIL:
...
;     Result: NIL
;     Expect: ("a b d")
; GC Fence 4,304,472 => 8,862,216
; GC Fence 3,921,600 => 8,871,432
;   FAIL:
...
;     Result: NIL
;     Expect: ("01/01/2000")
; GC Fence 4,249,864 => 8,883,312
; GC Fence 4,244,528 => 8,893,648
;   FAIL:
...
;     Result: ("aaa")
;     Expect: NIL
; GC Fence 4,246,096 => 9,030,872
; GC Fence 4,334,824 => 9,038,456
;   FAIL:
